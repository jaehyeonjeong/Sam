...
QT_MOC_LITERAL(1, 11, 12), // "sendDownload"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 18), // "onDownloadProgress"
QT_MOC_LITERAL(4, 44, 10), // "onFinished"
QT_MOC_LITERAL(5, 55, 14), // "QNetworkReply*"
QT_MOC_LITERAL(6, 70, 15) // "onReplyFinished"

    },
    "Downloader\0sendDownload\0\0onDownloadProgress\0"
    "onFinished\0QNetworkReply*\0onReplyFinished"
};
...
void Downloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Downloader::sendDownload)) {
                *result = 0;
                return;
            }
        }
